...
class _CalendarScreenState extends State<CalendarScreen> {
                      ...
                      child: TableCalendar(
                        ...
                        calendarBuilders: CalendarBuilders(
                          defaultBuilder: (context, day, focusedDay) {
                            final status = widget.shiftPattern.getShiftStatus(day);
                          ...
                          todayBuilder: (context, day, focusedDay) {
                            final status = widget.shiftPattern.getShiftStatus(day);
                            return _buildCalendarDay(day, status, false, isToday: true);
                          },
                        ),
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      _buildLegendItem('주간', Colors.amber[100]!, Colors.amber[200]!),
                      _buildLegendItem('야간', Colors.indigo[100]!, Colors.indigo[200]!),
                      _buildLegendItem('휴무', Colors.red[100]!, Colors.red[200]!),
                    ],
                  ),
                ),
              ),
  ...
  Widget _buildCalendarDay(DateTime day, DayStatus? status, bool isSelected,
      {bool isToday = false}) {
